...
echo "checking in /sys/fs/cgroup/cpuacct"
...
total_periods_start=$(cat /sys/fs/cgroup/cpuacct/cpu.stat | awk 'FNR == 1 {print $2}')
throttled_periods_start=$(cat /sys/fs/cgroup/cpuacct/cpu.stat | awk 'FNR == 2 {print $2}')
throttled_time_start=$(cat /sys/fs/cgroup/cpuacct/cpu.stat | awk 'FNR == 3 {print $2}')
...
total_periods_stop=$(cat /sys/fs/cgroup/cpuacct/cpu.stat | awk 'FNR == 1 {print $2}')
throttled_periods_stop=$(cat /sys/fs/cgroup/cpuacct/cpu.stat | awk 'FNR == 2 {print $2}')
throttled_time_stop=$(cat /sys/fs/cgroup/cpuacct/cpu.stat | awk 'FNR == 3 {print $2}')
